...
class RecognitionHistoryRepository
    ...
    constructor(
        ...
        fun search(query: String): Flow<List<RecognitionHistoryEntity>> = if (query.isBlank()) dao.getAll() else dao.search(query.trim())

        suspend fun save(result: RecognitionResult): Long =
            dao.insert(
