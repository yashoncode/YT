...
object UmpVarInt {
    ...
    private fun decodeBytes(
        ...
        when (size) {
            ...
            5 -> {
                ...
                throw IllegalStateException("Invalid UMP varint size: $size")
            }
        }
    ...
    fun encode(value: Long): ByteArray =
        when {
            value < 0 -> {
                throw IllegalArgumentException("UMP varint cannot be negative: $value")
            }
            ...
            value <= 0xFFFFFFFFL -> {
                ...
                throw IllegalArgumentException("UMP varint value too large: $value")
            }
        }
